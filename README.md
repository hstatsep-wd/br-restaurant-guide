...
1. Notice that the **American** section is completely finished.  All links direct the user to the appropriate file/website.  
  a. _**IMPORTANT**: the links only work when viewed on GitHub.  On your IDE, only one markdown file can be previewed at a time_ (`404 error`)_, so the links will not appear to work until_ `push`_ed to GitHub._
